<script>
    ...
    let one, oneOne;
    let two, twoOne, twoTwo, twoTwoOne, twoTwoTwo, twoTwoThree, twoTwoFour, twoThree;
...
<div class="constitution">
    ...
    <p>If a trade is being made during the draft, one or both parties can alert the commissioners to pause the draft to allow for extra time to negotiate the trade.</p>
    ...
    <p>NOTE: Playoffs Style is Re-Seed. The higher seeded teams always play lower-seeded teams in every round</p>
    ...
    <ol>
        ...
        <li>Coin Flip or Duel to the death</li>
    </ol>
    ...
    <p>League dues are set at ${dues} for all the following seasons, with $25 being held as an early deposit for next season every year. All managers must be fully paid before the start of the rookie draft. In the event that a manager fails to pay before the deadline, an additional $25 penalty will be added to their payment and will go towards the payouts at the end of the year.</p>
    ...
    <p>A 8/2 majority vote is required in order to raise league dues. In the event that a manager is no longer financially comfortable with the buy-in, finding a co-manager to split the cost is recommended.</p>
