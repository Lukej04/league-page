...
<div class="constitution">
    ...
    <h3 class="noUnderscore clickable" on:click={() => goToSection(two)}>Section 2: Drafting</h3>
        ...
        <h4 class="noUnderscore clickable" on:click={() => goToSection(twoOne)}>2.1 Rookie Draft</h4>
    ...
    <h3 bind:this={twoOne}>2.1 Rookie Draft</h3>
